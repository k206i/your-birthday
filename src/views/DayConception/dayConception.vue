    ...
    <ion-content :fullscreen="true" class="ion-padding">
      ...
      <Transition name="brd-fade">
        <div v-if="conceptionDay">
          ...
          <WidgetTipInfo>
            Точную дату зачатия знает только календарь... и то не факт 😄 При нормальном течении беременности всё могло случиться <span :style="{color: SUB_THEME_COLOR}">на несколько дней раньше или позже</span> расчётной даты рождения. Поэтому давайте посмотрим, какие события происходили в период <span :style="{color: SUB_THEME_COLOR}">наиболее вероятного зачатия</span>.
          </WidgetTipInfo>
